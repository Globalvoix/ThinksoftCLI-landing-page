...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/thinksoft/thinksoft/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for thinksoft/thinksoft...\n")
...
console.log("Fetching npm all-time downloads for Thinksoft-ai...\n")
const npmDownloads = await fetchNpmDownloads("Thinksoft-ai")
