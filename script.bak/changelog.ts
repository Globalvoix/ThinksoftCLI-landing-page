...
Generates UPCOMING_CHANGELOG.md by running the Thinksoft changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for Thinksoft run (default: low)
      --quiet            Suppress Thinksoft command output unless it fails
