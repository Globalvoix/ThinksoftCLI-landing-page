...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/Thinksoft`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy Thinksoft service removed
