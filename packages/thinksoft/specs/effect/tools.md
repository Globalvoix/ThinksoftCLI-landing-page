...
Practical reference for the current tool-migration state in `packages/Thinksoft`.
...
Tool tests should use the existing Effect helpers in `packages/Thinksoft/test/lib/effect.ts`:
