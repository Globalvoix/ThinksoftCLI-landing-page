...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/Thinksoft.git")).toEqual({ owner: "sst", repo: "Thinksoft" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/Thinksoft")).toEqual({ owner: "sst", repo: "Thinksoft" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/Thinksoft.git")).toEqual({ owner: "sst", repo: "Thinksoft" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/Thinksoft")).toEqual({ owner: "sst", repo: "Thinksoft" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/Thinksoft.git")).toEqual({ owner: "sst", repo: "Thinksoft" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/Thinksoft")).toEqual({ owner: "sst", repo: "Thinksoft" })
})
