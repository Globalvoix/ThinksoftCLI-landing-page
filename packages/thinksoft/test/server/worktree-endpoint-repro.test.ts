...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      THINKSOFT_EXPERIMENTAL_WORKSPACES: Flag.THINKSOFT_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.THINKSOFT_EXPERIMENTAL_WORKSPACES = original.THINKSOFT_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
