...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips Thinksoft-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-Thinksoft-directory"]).toBeUndefined()
      expect(forwarded["x-Thinksoft-workspace"]).toBeUndefined()
