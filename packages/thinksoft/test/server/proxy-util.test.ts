...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips Thinksoft-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-Thinksoft-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-Thinksoft-directory")).toBeNull()
      expect(result.get("x-Thinksoft-workspace")).toBeNull()
