...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders THINKSOFT_CALLER", () => {
    process.env["THINKSOFT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode THINKSOFT_CALLER", () => {
    process.env["THINKSOFT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown THINKSOFT_CALLER", () => {
    process.env["THINKSOFT_CALLER"] = "unknown"
