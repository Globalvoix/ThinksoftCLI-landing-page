import type { JsonSchema, LLMRequest, ProviderMetadata } from "@thinksoft/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@thinksoft/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @thinksoft/llm request objects from Thinksoft's session/AI SDK-shaped data.
  return LLM.request({
