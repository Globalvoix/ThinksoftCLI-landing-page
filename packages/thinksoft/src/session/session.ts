...
import { PermissionV1 } from "@thinksoft/core/v1/permission"
import { Slug } from "@thinksoft/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@thinksoft/llm"
...
import { SessionV2 } from "@thinksoft/core/session"
import { SessionExecution } from "@thinksoft/core/session/execution"
...
import { PartTable, SessionTable } from "@thinksoft/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@thinksoft/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".Thinksoft", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/Session") {}
