...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __THINKSOFT_PHOTON_WASM_PATH?: string }).__THINKSOFT_PHOTON_WASM_PATH =
