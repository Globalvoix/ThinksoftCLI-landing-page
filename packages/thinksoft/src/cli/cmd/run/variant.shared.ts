...
//
// The saved variant persists across sessions in ~/.local/state/Thinksoft/model.json
...
class Service extends Context.Service<Service, VariantService>()("@Thinksoft/RunVariant") {}
