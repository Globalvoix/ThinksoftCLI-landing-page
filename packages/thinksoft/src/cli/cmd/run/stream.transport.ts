...
import type { Event, GlobalEvent, ThinksoftClient } from "@thinksoft/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@Thinksoft/RunStreamTransport") {}
