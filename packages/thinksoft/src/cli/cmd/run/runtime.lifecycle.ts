...
import { openEditor } from "@thinksoft/tui/editor"
import { registerThinksoftKeymap } from "@thinksoft/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerThinksoftKeymap(keymap, renderer, input.tuiConfig)
