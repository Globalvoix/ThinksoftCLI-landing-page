...
import { ProjectDirectoryTable, ProjectTable } from "@thinksoft/core/project/sql"
...
import { which } from "@thinksoft/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@thinksoft/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.THINKSOFT_FAKE_VCS)
