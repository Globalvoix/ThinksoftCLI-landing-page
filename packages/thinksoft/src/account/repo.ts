...
import { AccountStateTable, AccountTable } from "@thinksoft/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/AccountRepo") {}
