 ...
 *   "@Thinksoft/ServerAuthConfig",
 *   {
 *     password: Config.string("THINKSOFT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("THINKSOFT_SERVER_USERNAME").pipe(Config.withDefault("Thinksoft")),
 *   },
 * ) {}
 *
