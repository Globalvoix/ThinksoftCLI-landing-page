...
export const RootHttpApi = HttpApi.make("Thinksoft-root")
...
export const InstanceHttpApi = HttpApi.make("Thinksoft-instance")
...
export const ThinksoftHttpApi = HttpApi.make("Thinksoft")
