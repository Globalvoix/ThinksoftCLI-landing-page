...
>()("@Thinksoft/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@Thinksoft/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.THINKSOFT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.THINKSOFT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-Thinksoft-directory"] || process.cwd()
}
