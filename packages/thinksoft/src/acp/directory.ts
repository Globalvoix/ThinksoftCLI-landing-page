...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@Thinksoft/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@Thinksoft/ACPDirectory") {}
