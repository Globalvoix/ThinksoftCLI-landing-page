...
import type { AssistantMessage as ThinksoftAssistantMessage, Message } from "@thinksoft/sdk/v2"
...
export type AssistantTokenCost = Pick<ThinksoftAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ThinksoftAssistantMessage, "role"> &
  Partial<Pick<ThinksoftAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@Thinksoft/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@Thinksoft/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@Thinksoft/ACPUsage") {}
