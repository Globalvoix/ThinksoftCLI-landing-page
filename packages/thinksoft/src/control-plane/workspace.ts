...
import { EventSequenceTable, EventTable } from "@thinksoft/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        THINKSOFT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        THINKSOFT_WORKSPACE_ID: config.id,
        THINKSOFT_EXPERIMENTAL_WORKSPACES: "true",
