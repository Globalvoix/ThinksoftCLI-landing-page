...
import { httpClient, path } from "@thinksoft/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/SkillDiscovery") {}
