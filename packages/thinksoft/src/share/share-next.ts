...
import type * as SDK from "@thinksoft/sdk/v2"
...
import { SessionShareTable } from "@thinksoft/core/share/sql"
...
const disabled = process.env["THINKSOFT_DISABLE_SHARE"] === "true" || process.env["THINKSOFT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/ShareNext") {}
