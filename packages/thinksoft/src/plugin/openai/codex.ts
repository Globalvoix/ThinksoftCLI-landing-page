...
<html>
  <head>
    <title>Thinksoft - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>Thinksoft - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "Thinksoft"
      output.headers["User-Agent"] = `Thinksoft/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
