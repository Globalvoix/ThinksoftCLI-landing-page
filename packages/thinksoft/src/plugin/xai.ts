...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=Thinksoft` lets xAI attribute Thinksoft-originated
...
<html>
  <head>
    <title>Thinksoft - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>Thinksoft - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire Thinksoft process. Matches the silent-
