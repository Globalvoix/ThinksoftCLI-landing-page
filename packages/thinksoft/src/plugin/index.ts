...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "thinksoft-gitlab-auth"
import { PoeAuthPlugin } from "thinksoft-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@Thinksoft/Plugin") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        const client = createThinksoftClient({
